...
class ReportController extends Controller
{
    ...
    public function report_template(Request $request)
    {
        $user    = UserDetail::where('email', Auth::user()->email)->first();
        $library = $user->library;
        ...
        return view('reports.report_template', [
            'patrons'  => $patrons,
            'colleges' => $colleges,
            'programs' => $programs,
            'prepared_by' => $person
    ...
    public function report_template_inventory(Request $request)
    {
        $user    = UserDetail::where('email', Auth::user()->email)->first();
        $library = $user->library;
        $user_id = Auth::user()->card_number;
        ...
        return view('reports.report_inventory', [
            'items'      => $items,
            'publishers' => $publishers,
            'prepared_by' => $person
        ]);
    ...
    public function report_template_count(Request $request)
    {
        $user    = UserDetail::where('email', Auth::user()->email)->first();
        $library = $user->library;
        $user_id = Auth::user()->card_number;
        ...
        return view('reports.report_count', [
            'items'      => $items,
            'publishers' => $publishers,
            'prepared_by' => $person
        ]);
    ...
    public function report_template_attendance(Request $request)
    {
        $user    = UserDetail::where('email', Auth::user()->email)->first();
        $library = $user->library;
        $user_id = Auth::user()->card_number;
        ...
        return view('reports.report_attendance', [
            'patrons'  => $patrons,
            'colleges' => $colleges,
            'programs' => $programs,
            'prepared_by' => $person

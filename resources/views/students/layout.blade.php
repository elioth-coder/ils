<x-layout>
    ...
    <main class="d-flex flex-column justify-content-center w-100 bg-body-secondary">
        ...
        <div class="container d-flex flex-column pb-5 row-gap-4">
            <section class="w-100">
                <a href="/patrons/students#students-form" class="btn btn-outline-success">
                    New Student
                            ...
                            <tr>
                                <td>
                                    <form id="delete-student-{{ $student->id }}"
                                        action="/patrons/students/{{ $student->id }}" method="POST" class="d-none">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit">DELETE</button>
                                    </form>
                                    <a title="Edit" href="/patrons/students/{{ $student->id }}/edit#students-form" class="btn btn-light btn-sm">

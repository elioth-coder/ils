                ...
                <div class="w-100">
                        ...
                        <div class="mb-2 w-100">
                            @php
                                if($errors->has('accession_number')) {
                                    ...
                                    $accession_number = (old('accession_number')) ? old('accession_number') : $selected->accession_number;
                                }
                            @endphp
                            <label for="accession_number" class="form-label">Accession No.</label>
                            <input type="text" class="form-control form-control-sm" placeholder="--" name="accession_number" id="accession_number" value="{{ $accession_number }}">
                        ...
                        <div class="mb-2 w-100">
                            @php
                                if($errors->has('barcode_number')) {
                                    ...
                                    $barcode_number = (old('barcode_number')) ? old('barcode_number') : $selected->barcode_number;
                                }
                            @endphp
                            <label for="barcode_number" class="form-label">Barcode No.</label>
                            <input type="text" class="form-control form-control-sm" placeholder="--" name="barcode_number" id="barcode_number" value="{{ $barcode_number }}">
                    ...
                    <div class="d-flex column-gap-2">
                        <div class="mb-2 w-100">
                            ...
                            <input type="text" class="form-control form-control-sm" placeholder="--" name="lcc_number" id="lcc_number" value="{{ $lcc_number }}">
                            @error('lcc_number')
                                <div class="form-text text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-2 w-100">
                            ...
                            <input type="text" class="form-control form-control-sm" placeholder="--" name="ddc_number" id="ddc_number" value="{{ $ddc_number }}">
                            @error('ddc_number')
                                <div class="form-text text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" class="form-control form-control-sm" placeholder="--" name="title" id="title" value="{{ $title }}">
                        @error('title')
                            <div class="form-text text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="d-flex column-gap-2">
                        <div class="mb-2 w-100">
                            ...
                            <input type="text" class="form-control form-control-sm" placeholder="--" name="author" id="author" value="{{ $author }}">
                            @error('author')
                                <div class="form-text text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-2 w-100">
                            ...
                            <input type="text" class="form-control form-control-sm" placeholder="--" name="isbn" id="isbn" value="{{ $isbn }}">
                            @error('isbn')
                                <div class="form-text text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="d-flex column-gap-2">
                        <div class="mb-2 w-100">
                            ...
                            <input type="text" class="form-control form-control-sm" placeholder="--" name="publisher" id="publisher" value="{{ $publisher }}">
                            @error('publisher')
                                <div class="form-text text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-2 w-100">
                            @php
                                if($errors->has('publication_year')) {
                                    ...
                                    $publication_year = (old('publication_year')) ? old('publication_year') : $selected->publication_year;
                                }
                    ...
                    <div class="d-flex column-gap-2">
                        ...
                        <div class="mb-2 w-100">
                            ...
                            <input type="text" class="form-control form-control-sm" placeholder="--" name="price" id="price" value="{{ $price }}">
                            @error('price')
                                <div class="form-text text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mb-2">
                        ...
                        <textarea style="height: 172px;" class="form-control form-control-sm" placeholder="--" name="summary" id="summary" rows="4">{{ $summary }}</textarea>
                        @error('summary')
                            <div class="form-text text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="w-100 d-flex flex-column">
                    <div class="flex-grow-1 rounded d-flex align-items-center justify-content-center">
                        <div id="book-cover-container" class="border text-center shadow">
                            @php $book_cover = ($selected->cover_image) ? $selected->cover_image : 'book_cover_not_available.jpg'; @endphp
                            <img id="book-cover" class="h-100 d-block" src="{{ asset("/storage/images/books/$book_cover") }}" alt="">
                        </div>
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" class="form-control form-control-sm" placeholder="--" name="tags" id="tags" value="{{ $tags }}">
                        @error('tags')
                            <div class="form-text text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                        ...
                        <div class="mb-2 w-100">
                            ...
                            <select class="form-control form-control-sm" name="genre" id="genre">
                                ...
                                @foreach($genres as $_genre)
                                    <option {{ $_genre==$genre ? "selected" : "" }} value="{{ $_genre }}">{{ $_genre }}</option>
                                @endforeach
                            </select>
                            @error('genre')
                                <div class="form-text text-danger">{{ $message }}</div>
                        ...
                        <div class="mb-2 w-100">
                            ...
                            <select class="form-control form-control-sm text-capitalize" name="format" id="format">
                                ...
                                @foreach ($formats as $_format)
                                    <option {{ $_format==$format ? "selected" : "" }} value="{{ $_format }}">{{ $_format }}</option>
                                @endforeach
                            </select>
                            @error('format')
                                <div class="form-text text-danger">{{ $message }}</div>

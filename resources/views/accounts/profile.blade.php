<x-layout>
    ...
    <main class="d-flex align-items-center justify-content-center w-100 bg-light">
        <div class="container d-flex flex-column py-1">
            ...
            <form action="/accounts/edit_profile" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                    ...
                    <div class="w-100">
                            ...
                            <div class="mb-2 w-100">
                                @php
                                    if($errors->has('employee_number')) {
                                        ...
                                        $employee_number = (old('employee_number')) ? old('employee_number') : $user->employee_number;
                                    }
                                @endphp
                                <label for="employee_number" class="form-label">Employee No.</label>
                                <input disabled type="text" class="form-control form-control-sm" placeholder="--" name="employee_number" id="employee_number" value="{{ $employee_number }}">
                        ...
                        <div class="d-flex column-gap-2">
                            ...
                            <div class="mb-2 w-100">
                                ...
                                <input disabled type="date" class="form-control form-control-sm" placeholder="--" name="birthday" id="birthday" value="{{ $birthday }}">
                                @error('birthday')
                                    <div class="form-text text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-2 w-100">
                                @php
                                    if($errors->has('college')) {
                                        ...
                                        $college = (old('college')) ? old('college') : $user->college;
                                    }
                                @endphp
                            ...
                            <div class="mb-2 w-100">
                                @php
                                    if($errors->has('campus')) {
                                        ...
                                        $campus = (old('campus')) ? old('campus') : $user->campus;
                                    }
                                @endphp
                            ...
                            <div class="mb-2 w-100">
                                @php
                                    if($errors->has('academic_rank')) {
                                        ...
                                        $academic_rank = (old('academic_rank')) ? old('academic_rank') : $user->academic_rank;
                                    }
                                @endphp
                ...
                <div class="d-flex gap-2 flex-row-reverse mt-3">
                    <a href="/dashboard" class="btn btn-outline-dark px-3">Cancel</a>

@component('researches.layout', [
    ...
    @slot('form')
        ...
        <form action="/collections/researches" method="POST" enctype="multipart/form-data">
            @csrf
            @method('POST')
            <h4 class="text-body-secondary">Create new thesis/research</h4>
            <hr>
                ...
                <div class="w-100 d-flex flex-column">
                    <div class="flex-grow-1 rounded d-flex align-items-center justify-content-center">
                        <div id="research-cover-container" class="border text-center shadow">
                            <img id="research-cover" class="h-100 d-block" src="{{ asset('images/book_cover_not_available.jpg') }}" alt="">
                        </div>

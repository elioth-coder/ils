<x-layout>
                ...
                <div class="">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="requested-items-tab" data-bs-toggle="tab"
                                data-bs-target="#requested-items" type="button" role="tab" aria-controls="requested-items"
                                aria-selected="true">
                                Requests
                                @if (count($requested_items))
                                    <span class="badge text-bg-primary">{{ count($requested_items) }}</span>
                                @endif
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="cancelled-items-tab" data-bs-toggle="tab"
                                data-bs-target="#cancelled-items" type="button" role="tab" aria-controls="cancelled-items"
                                aria-selected="false">
                                Cancelled
                            </button>
                        </li>
                    ...
                    <div class="tab-content p-4 bg-white border border-top-0 rounded rounded-top-0">
                        <div class="tab-pane active" id="requested-items" role="tabpanel" aria-labelledby="requested-items-tab" tabindex="0">
                            <table id="requested-items-table" class="table">
                                <thead>
                                    <tr>
                        ...
                        <div class="tab-pane" id="cancelled-items" role="tabpanel" aria-labelledby="cancelled-items-tab" tabindex="0">
    ...
    <x-slot:script>
        <script>
            new DataTable('#requested-items-table');
